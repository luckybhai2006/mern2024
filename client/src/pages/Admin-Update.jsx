...
const params = useParams();
  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
      try {
        const response = await fetch(`https://mern2024-2095.onrender.com/api/admin/users/${params.id}`, {
          method: 'GET',
          headers: {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://mern2024-2095.onrender.com/api/admin/users/update${params.id}`, {
        method: 'PATCH',
        headers: {
