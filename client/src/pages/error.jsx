...
const ErrorPage = ({ errorCode = "404", message = "Oops! Page Not Found" }) => {
  return (
    <div className="container text-center mt-5">
      ...
      <div className="col-md-6 col-lg-9" style={{ height: '100%', width: "100%",marginTop:'40px'
         }}>
        <div className="card error-card p-0">
          <div className="card-body" style={{ background: 'white',border: "5px solid red",}}>
            <img
